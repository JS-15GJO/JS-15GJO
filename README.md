...
_[테킷 멋쟁이 사자처럼]_ 프론트엔드 스쿨 6기

|  이름  |           GitHub           |           담당페이지            |
| :----: | :------------------------: | :-----------------------------: |
| 강경민 | https://github.com/minomad |    방문 페이지, 리뷰 페이지     |
| 강예나 |  https://github.com/yenaf  | 로그인 페이지, 회원가입 페이지  |
| 박지함 |  https://github.com/itzwe  | 테마 생성 및 리스트 출력 페이지 |
| 전선용 | https://github.com/sy0725  |   피드 페이지, 가게 상세정보    |
| 박지영 | https://github.com/yxxung  |  테마 페이지, 리뷰 선택 페이지  |
...
1.  시작 페이지
    <img src = "./client/assets/images/github/index.png" width="200px">
    <br>
...
<table>
<tr>
<td><img src = "./client/assets/images/github/map1.png" width="200px"></td>
<td> <img src = "./client/assets/images/github/map2.png" width="195px"></td>
</tr>
</table>
